...
public class PayPwdEditText extends RelativeLayout {
    ...
    public void initStyle(int bgdrawable, int pwdlength, float splilinewidth, int splilinecolor, int pwdcolor, int pwdsize, int inputtype) {
        this.pwdlength = pwdlength;
        initEdit(bgdrawable, inputtype);
        initShowInput(bgdrawable, pwdlength, splilinewidth, splilinecolor, pwdcolor, pwdsize);
    }
     ...
     * @param bgcolor
     */
    private void initEdit(int bgcolor, int inputtype) {
    ...
    public void initShowInput(int bgcolor, int pwdlength, float slpilinewidth, int splilinecolor, int pwdcolor, int pwdsize) {
        ...
        for (int i = 0; i < textViews.length; i++) {
            ...
            if (i > 0) {
                params.setMargins((int) DeviceUtil.dipToPx(context, 5), 0, 0, 0);
            }
            final int index = i;
