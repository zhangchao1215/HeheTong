...
public class MasterPeopleFansActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        fansBeanList = new ArrayList<>();

        masterText.setText("粉丝列表");
    ...
    public void masterEventFans(MasterEvBean bean) {

        List<MasterDetailBean.DataBean.FansBean> mfansBeanList = bean.getFansBeanList();
        fansBeanList.addAll(mfansBeanList);

        fansAdapter = new MasterFansAdapter(fansBeanList, this);
        masterPeopleRecycler.setAdapter(fansAdapter);
