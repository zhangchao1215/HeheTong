...
public class KunTicketActivity extends BaseActivity {
    ...
    protected void initView() {
        mTextIncludeTitle.setText("坤券账户");
        mTextIncludeTitle.setTextSize(16);

        mTextGetYiTicket.setText("如何赚取坤劵");

        mTextTicketBalance.setText("坤券余额");

        mTextRecord.setText("坤券记录");
    }
