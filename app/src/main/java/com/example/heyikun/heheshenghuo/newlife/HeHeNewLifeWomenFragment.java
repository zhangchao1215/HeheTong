...
import com.example.heyikun.heheshenghuo.controller.activity.ZhenDuanActivityWomen;
...
public class HeHeNewLifeWomenFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.activity_new_hehe_life_woman;
    }
    ...
    private void clickImage(RelativeLayout jin, RelativeLayout mu, RelativeLayout shui, RelativeLayout huo, RelativeLayout tu) {
        ...
        jin.setBackgroundResource(R.drawable.click_biaoqian_women4x);
        mu.setBackgroundResource(R.drawable.noclick_biaoqian_women_4x);
        shui.setBackgroundResource(R.drawable.noclick_biaoqian_women_4x);
        huo.setBackgroundResource(R.drawable.noclick_biaoqian_women_4x);
        tu.setBackgroundResource(R.drawable.noclick_biaoqian_women_4x);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.bianzheng_relative:
                Intent intent1 = new Intent(getContext(), ZhenDuanActivityWomen.class);
            ...
            case R.id.new_image_huo:
                ...
                wuxingImageppw();
                ppwDown.showAsDropDown(view, -240, 0);
            ...
            case R.id.new_image_shui:
                ...
                wuxingImageppw();
                ppwDown.showAtLocation(view, Gravity.NO_GRAVITY, shuilocation[0] - 200, shuilocation[1] - ppwDown.getHeight() - 100);
            ...
            case R.id.new_image_jin:
                ...
                ppwDown.showAtLocation(view, Gravity.NO_GRAVITY, toplocation[0] - 200, toplocation[1] - ppwDown.getHeight() - 100);
    ...
    private void ChangeImage(int time) {
        switch (time) {
            case 1:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zujueyinganjing_4woman));
            ...
            case 3:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shoutaiyinfeijing_4woman));
            ...
            case 5:
                ...
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shouyangmingdachangjing_4woman));
            ...
            case 7:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zuyangmingweijing_4woman));
            ...
            case 9:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zutaiyinpijing_4woman));
            ...
            case 11:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shoushaoyinxinjing_4woman));
            ...
            case 13:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shoutaiyangxiaochangjing_4woman));
            ...
            case 15:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zutaiyangpangguangjing_4woman));
            ...
            case 17:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zushaoyinshenjing_4woman));
            ...
            case 19:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shoujueyinxinbaojing_4woman));
            ...
            case 21:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.shoushaoyangsanjiaojing_4woman));
            ...
            case 22:
                ...
                break;
            case 23:
                ManLeftImage.setImageDrawable(getResources().getDrawable(R.drawable.zushaoyangdnjing_4woman));
    ...
    private void wuxingImageppwlife(View v) {
        ...
        ppw = new PopupWindow(mView, ViewGroup.LayoutParams.MATCH_PARENT
                , ViewGroup.LayoutParams.MATCH_PARENT, true);
    ...
    private void noClickImage() {
        ...
        newImageMu.setImageResource(R.drawable.muwomen_4x);
        newImageJin.setImageResource(R.drawable.jinwomen_4x);
        newImageShui.setImageResource(R.drawable.shuiwomen_4x);
        newImageHuo.setImageResource(R.drawable.huowomen_4x);
        newImageTu.setImageResource(R.drawable.tuwomen_4x);
