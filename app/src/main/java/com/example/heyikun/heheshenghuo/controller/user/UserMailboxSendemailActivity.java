 ...
 * 3：类描述：发送邮箱验证码
 * <p>
 * 4:类功能： 输入邮箱，点击进行发送邮箱验证码，调到另一页面
 */

public class UserMailboxSendemailActivity extends BaseActivity {
    ...
    private void mPopWindow() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ppw.dismiss();
                backgroundAlpha(1f);
                Intent intent = new Intent(UserMailboxSendemailActivity.this, UserInputMailBoxVerifyActivity.class);
        ...
        OkHttpUtils.getInstands().OkhttpPost(BaseUrl.BaseUrl, params, "", new MyCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                if (!bean.getStatus().equals("200")) {
                    ...
                    mPopWindow();
                    Toast.makeText(UserMailboxSendemailActivity.this, "邮箱绑定成功", Toast.LENGTH_SHORT).show();
                }
