...
public class PhoneVerifyPwdActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mTextIncludeTitle.setText("手机验证重置密码");
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            mButGetAuthCode.setBackground(getResources().getDrawable(R.drawable.shape_send_code));
        }
    }
                ...
                .enqueue(new GsonResponseHandler<ChangePwdBean>() {
                    ...
                    public void onSuccess(int statusCode, ChangePwdBean response) {
                        ...
                        if (response.getStatus().equals("200")) {
                            time.start();
                            Toast.makeText(PhoneVerifyPwdActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void MobileCode(String code) {
        ...
        try {
            String encryptCode = AESUtils.Encrypt(BaseCode, BaseUrl.AESKey);
            Map<String, String> params = new HashMap<>();
            ...
            OkHttpUtils.getInstands().OkhttpPost(BaseUrl.BaseUrl, params, "", new MyCallBack() {
                ...
                public void onSuccess(String data) {
                    Log.d("PhoneVerifyPwdActivity", "验证短信" + data);
                    Gson gson = new Gson();
                    ...
                    if (bean == null || data == null) {
                        ...
                        Intent intent = new Intent(PhoneVerifyPwdActivity.this, UserChongZhi_PhoneVerifyPwd.class);
                        EventBus.getDefault().postSticky(phonebean);


                        startActivity(intent);
                    } else {
                        Toast.makeText(PhoneVerifyPwdActivity.this, bean.getMessage(), Toast.LENGTH_SHORT).show();
                    }
