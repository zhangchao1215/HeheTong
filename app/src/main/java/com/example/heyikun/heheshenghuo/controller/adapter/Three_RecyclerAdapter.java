...
public class Three_RecyclerAdapter extends RecyclerView.Adapter<Three_RecyclerAdapter.MHodler> {
    ...
    public Three_RecyclerAdapter(List<Second_RecyclerBean.DataBean> mList, Context content) {
        this.mList = mList;
