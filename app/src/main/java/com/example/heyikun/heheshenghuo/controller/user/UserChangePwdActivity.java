...
public class UserChangePwdActivity extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ChangePwd_mButYes:
                ...
                } else if (nextPwd.length() < 6) {
                    Toast.makeText(this, "密码不能小于6位", Toast.LENGTH_SHORT).show();
                } else
                    requestChangePwd(oldPwd, nextPwd);
    ...
    private void mPopWindow() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //修改密码成功之后跳转到首页
                Intent intent = new Intent(UserChangePwdActivity.this, HeHeMainActivity.class);
    ...
    private void requestChangePwd(String oldPwd, String newPwd) {
        ...
        String app_signMd5 = "UpPass" + timestamp + BaseUrl.AESKey;
                ...
                .enqueue(new GsonResponseHandler<ChangePwdBean>() {
                    ...
                    public void onSuccess(int statusCode, ChangePwdBean response) {
                        ...
                        if (response.getStatus().equals("200")) {
                            ...
                            Toast.makeText(UserChangePwdActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                        }
