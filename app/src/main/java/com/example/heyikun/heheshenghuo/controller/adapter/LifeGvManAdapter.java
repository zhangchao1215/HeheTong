...
public class LifeGvManAdapter extends BaseAdapter {
    private List<HeHeYangshenBean.DataBean.BodyBean> mList;
    private Context context;


    public LifeGvManAdapter(List<HeHeYangshenBean.DataBean.BodyBean> mList, Context context) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context)
                ...
                .centerCrop()
                .placeholder(R.drawable.wt_man_4x)
                .into(hoder.image);
