...
public class EBLoginBean {
   ...
   //设置主题
    ...
    public EBLoginBean(String brief, String await_receipt, String payback, String await_comment, String await_ship, String await_pay, String userMoney, String heTicket, String yiTicket, String kunTicket, String profit, String bigcast, String fans, String follow, String theme, String replay) {
        this.brief = brief;
