...
public class
ZhenDuanActivityWomen extends BaseActivity implements View.OnClickListener, PopupSheTaiAdapter.SheTaiItemClickListener {
    ...
    protected int layoutId() {
        return R.layout.activity_shouye_self_diagnose_women;
    }
    ...
    private void getJianceTitle() {
        ...
        OkHttpUtils.getInstands().OkhttpPost(BaseUrl.BaseUrl, map, "", new MyCallBack() {
            ...
            public void onSuccess(final String data) {
                ...
                Glide.with(ZhenDuanActivityWomen.this)
                        .load(mData.get(0).getPic_url())
                        .placeholder(R.drawable.shoujueyinxinbaojing_4woman)
                        .into(SelfManImage);
                ...
                SelfTitleTab.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
                    ...
                    public void onTabSelected(TabLayout.Tab tab) {
                        ...
                        if (tabposition == 1) {
                            ...
                            Glide.with(ZhenDuanActivityWomen.this)
                                    .load(mData.get(5).getPic_url())
                                    .placeholder(R.drawable.shoujueyinxinbaojing_4woman)
                                    .into(SelfManImage);

                            mTextXiongFu.setText(mData.get(5).getTypename());
                            SelfRadioChaHao.setVisibility(View.GONE);
                            ZhenDuanJieGuoText.setVisibility(View.GONE);
                            SelfMLinearDongtaiSecond.setVisibility(View.GONE);
                            SelfSelectorText.setText("请选择您的症状：");
                            SelfTextKesou.setText(mData.get(5).getDesc());
                            ZhenDuanTextTitle.setText(mData.get(5).getTypename());
...
//                            mTextNext.setTextColor(getResources().getColor(R.color.colorTextWomen));
//
//                        } else if (type == 1) {
//                            SelfImageNext.setClickable(false);
...
//                SecondRecyclerView.setTypeThreeBack(getColor(R.color.colorTextWomen));
...
//                ThreeRecyclerView.setTypeThreeBack(getColor(R.color.colorTextWomen));
...
//    }
    ...
    private void mPopup() {
        ...
        View view = ZhenDuanActivityWomen.this.getLayoutInflater().inflate(R.layout.activity_shouye_shetai, null);

        mRelative = (RelativeLayout) view.findViewById(R.id.SheTai_ZhenDuan);
        mRelative.setBackgroundResource(R.drawable.shetai_zhenduan_shape_women);
        ...
        PopwindowAdapter = new PopupSheTaiAdapter(ZhenDuanActivityWomen.this, BeanList);
                ...
                try {
                    ...
                    if (data == null || successBean == null) {
                        ...
                        ResultLink.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                WebViewUtils.WebFrom(ZhenDuanActivityWomen.this, bean.getArticle().get(0).getLink(), bean.getName());
