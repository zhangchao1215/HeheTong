...
import com.example.heyikun.heheshenghuo.controller.adapter.LifeGvWomenAdapter;
...
public class HeHeLifeFragmentWomen extends BaseFragment implements PullDownScrollView.RefreshListener {
    ...
    private LifeGvWomenAdapter manAdapter;
    ...
    private void initList() {
        ...
        pullDownElasticImp.TopColor(R.color.colorTextWomen);
    ...
    protected int getLayoutId() {
        return R.layout.activity_main_women;
    }
    ...
    protected void initView(View view) {
        ...
        ManSaoMiaoImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getContext(), ZhenDuanActivityWomen.class));
            }
        });
        TimerPerson();  //切换图片
    ...
    private void YangShenDate(final String action) {
        ...
        try {
            ...
            if (!mUserId.equals("")) {
                ...
                encryptUserId = Encrypt(mUserId, BaseUrl.AESKey);
            }
        ...
        OkHttpUtils.getInstands().OkhttpPost(BaseUrl.BaseUrl, params, "", new MyCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                try {
                    ...
                    mList.addAll(body);
                    manAdapter = new LifeGvWomenAdapter(mList, getContext());
    ...
    private void ImageAnimator() {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(ManAnimatorImage, "TranslationY", translationY, 800f, translationY);
    ...
    private void MainRequest() {
        ...
        String token = user_id + "," + mtoken + "," + timestamp;
        ...
        try {
            if (!user_id.equals("") && !mtoken.equals("")) {
                ...
                AEStoken = Encrypt(token, BaseUrl.AESKey);
        ...
        OkHttpUtils.getInstands().OkhttpPost(BaseUrl.BaseUrl, params, "", new MyCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                if (mainBean.getStatus().equals("200")) {
                    ...
                    LifeTextDay.setText(dates.getSolar());

                    LifeTextYear.setText(dates.getYear());

                    LifeTextNongli.setText(dates.getLunar());
    ...
    private void getArticleList() {
        ...
        Log.d(TAG, "有没加密的userID" + encryptUserId);
        Log.d(TAG, "有没有加密的token" + encryptToken);
    ...
    public void MainUserImage() {
        ...
        Glide.with(getContext()).load(user_image).asBitmap().centerCrop().placeholder(R.drawable.touxiang_nan_man_4x).into(new BitmapImageViewTarget(LifeUserImage) {
            @Override
