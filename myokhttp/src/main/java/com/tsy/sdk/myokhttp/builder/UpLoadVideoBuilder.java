 ...
 * 修改时间:
 */
public class UpLoadVideoBuilder {
    private Map<String, File> files;
    private Map<String,String> params;
    private String url;
    private MyOkHttp myOkHttp;

    public UpLoadVideoBuilder(MyOkHttp myOkHttp) {
        files = new HashMap<>();
        params = new HashMap<>();
        this.myOkHttp = myOkHttp;
    }

    public UpLoadVideoBuilder url(String url) {
        this.url = url;
        return this;
    }

    public UpLoadVideoBuilder addFile(String key, File file) {
        files.put(key,file);
        return this;
    }
    public UpLoadVideoBuilder addPamars(String key, String value){
